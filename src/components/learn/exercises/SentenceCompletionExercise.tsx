...
export default function SentenceCompletionExercise({ exercise, onAnswer, onNext }: { exercise: Exercise, onAnswer: (isCorrect: boolean) => void, onNext: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full glass-surface p-8 rounded-xl">
      <div className="text-center mb-12">
        <h2 className="text-sm text-dark-400 mb-6 uppercase tracking-wider font-semibold">Complete the Sentence</h2>
        <p className="text-2xl font-medium text-dark-100 leading-relaxed italic">
          "{isAnswered && selected ? exercise.question.replace('______', exercise.correctAnswer) : exercise.question}"
        </p>
      </div>
